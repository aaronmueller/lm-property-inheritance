...
if __name__ == "__main__":
    ...
    #ONLY Train das on examples where it said yes to inferable case
    #NOTE this is called "test" but it is train
    prealign_dataloader_test = make_inputs_labels_dataset([i['input_ids'] for i in train], [i['output_ids'] for i in train] , [i['attention_masks'] for i in train])
    ...
    train = [train[i] for i in good_inds]
    print("Training dataset composition (hyp vs not): ", Counter([i['is_hyper'] for i in train]) )
